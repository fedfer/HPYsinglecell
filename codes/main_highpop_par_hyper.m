...
% ed Igor
[M_Tavoli,M_l_star,M_parametri,Dati_star,k_popolazioni]=posterior_K_hyper(data,M0,V0,J,n_init,iter,burnin);
...
[mjk_ini, m_dot_k_ini, m_j_dot_ini, m_dd_ini,alpha,d,gamma,nu,theta_h,a0,b0]=stima_parametri_hyper(M_l_star,tot_dist,M_parametri,J,iter-burnin);
...
%for III=1:Runs
    ...
    for i=1:addsample
        ...
        [alpha(III,:), d(III,:) ,gamma(III,1) ,nu(III,1), ...
            theta_h(III,1),a0(III,1),b0(III,1), M_parametri]=Filter_iperparametri_hyper(...
            mjk,m_j_dot,m_dd,m_dot_k,nj_dot_k,J,nn,bigK,N_iter,M_parametri);
