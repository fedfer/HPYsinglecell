...
function [ alpha, d ,gamma ,nu ,M_iperparametri_new]=Filter_iperparametri_v1(...
...
% same pesi_filter function as before, just need to compute the other
% weights as well
g=pesi_filter(mjk,m_j_dot,m_dd,m_dot_k,n_j_dot_k,J,nn,medie_mx,bigK,N_iter);
g_prec=pesi_filter(mjk_old,m_j_dot_old,m_dd_old,m_dot_k_old,...
...
[M_iperparametri_new_unnormalized, omega]=pesi_filter_new_v1(mjk,m_j_dot,m_dd,...
